 ...
 * 这个jQuery插件显示所选元素中的分页链接。
 * 
 * @author Gabriel Birke (birke *at* d-scribe *dot* de)
 * @version 1.1
 * @param {int} maxentries Number of entries to paginate              maxentries分页数
 * @param {Object} opts Several options (see README for documentation) 选择几个选项（参见文档的自述文件）
